...
class SEQUENCER_PT_scene(SequencerButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        #col.separator() 
        col.operator("view3d.add_scene_strip", text = "Add Camera to Sequencer", icon="CAMERA_DATA")                        
        #col.separator()
        col.operator("sequencer.convert_cameras", text = "Convert Camera Markes to Strips", icon="MARKER")                        
        #Ccol.separator()
        col.operator("sequencer.change_scene", text = "Toggle to Scene Strip Scene", icon="VIEW3D") 
...
# ------------------------------------------------------------------------
#     Toggle open scene strip in 3d view
# ------------------------------------------------------------------------
